...
```{r}
Posterior_beta=c(2.9+70, 2.0+80)

beta_prior_post(Prior_beta, Posterior_beta)
```

```{r}
install.packages(c("ggplot2", "sciplot", "reshape", "TeachBayes"), "C:/Users/nrb75/AppData/Local/Continuum/anaconda3/Lib/R/library")
```
...
```{r}
#y=rnorm(n=100, mean=0.6 sd=0.2) #mean=60%, standard deviation = 20%
